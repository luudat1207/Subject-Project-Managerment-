        ...
        <div class="wrapper d-flex flex-column min-vh-100 bg-light">
                    ...
                    <form id="__form">
                        <div class="row">
                            <div class="col-xl-8">
                                ...
                                <div class="card mb-4">
                                    <div id="_header" class="card-header">Add Tracking</div>
                                    <div class="card-body">
                                        ...
                                        <div class="row gx-3 mb-3">
                                            ...
                                            <div class="col-md-12">
                                                ...
                                                <select class="form-select form-select-sm" id="inputAssignerName" name="status_name" aria-label=".form-select-sm example">
                                        ...
                                        <div class="row gx-3 mb-3">
                                            ...
                                            <div class="col-md-12">
                                                ...
                                                <textarea class="form-control" id="inputTrackingNote" name="note_name" rows="3" ></textarea>
                                                <div class="invalid-feedback">
                                                    Note is too long.
                                                </div>
                                            </div>
                                        ...
                                        <button id="submit" class="btn btn-primary" type="button" onclick="save_change()">Add Tracking</button>
                                    </div>
                                </div>
                            </div>
                            <div class="col-xl-4">
            ...
            <script>
                function save_change() {
                    "class_id|team_id|milestone_name|funtion_name|assignee_name|assigner_name|status_name|note_name".split("|").forEach(err => $("[name='" + err + "']").removeClass("is-invalid"));
                    var wrapper = $("#__form").closest("div");
                    $(wrapper).find('[role="alert"]').remove();
                    $.ajax({
                        url: 'tracking',
                        data: $("#__form").serialize() + "&team_id=${team.getTeam_id()}&submit=submit",
                        cache: false,
                        processData: false,
                        type: 'POST',
