                        ...
                        <div class="card mb-4">
                            ...
                            <div class="card-body">
                                <div class="table-responsive"  id="__rxz">
                                    ...
                                    <a class="btn btn-outline-info" type="button" href="teamDetail?go=add">Add Team</a>
                                    <hr class="dropdown-divider">
                                        ...
                                        <tbody>
                                            <c:forEach items="${teams}" var="item">
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="teamDetail?go=edit&team_id=${item.getTeam_id()}" class="btn btn-primary rounded-pill btn-sm" type="button">Edit</a>
                                                    </td>
                                                </tr>
                                            </c:forEach>
                                        </tbody>
