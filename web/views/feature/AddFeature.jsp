                ...
                <div class="container-lg">
                    <div class="row">
                        ...
                        <div class="col-xl-12">
                            ...
                            <div class="card mb-4">
                                <div class="card-header"><strong>Add New Feature:</strong></div>
                                <div class="card-body">
                                    <form id="__form">
...
<input type="hidden" name="team_id" value="${team_id}">
                                            <div class="col-md-12">
                                                ...
                                                <input class="form-control" id="feature_name" type="text" name="feature_name"  placeholder="Enter your feature name" required>
                                        ...
                                        <div class="row gx-3 mb-3">
                                            <div class="col-md-6">
                                                ...
                                                <input class="form-control" id="team_id" type="text" value="${team_id}"name="team_id"  disabled >
                                        ...
                                        <div class="row gx-3 mb-3">
                                            <!-- Form Group (Status)-->
                                            <div class="col-md-12">
                                                <label class="form-label" for="exampleFormControlTextarea1">Description(Optional)</label>
