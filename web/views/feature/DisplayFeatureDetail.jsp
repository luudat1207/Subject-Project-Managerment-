    ...
    <head>
        ...
        <script>
            ...
            function save_change() {
                "feature_name|team_id|status".split("|").forEach(err => $("[name='" + err + "']").removeClass("is-invalid"));
                var wrapper = $("#__form").closest("div");
                $(wrapper).find('[role="alert"]').remove();
                $.ajax({
                    url: 'feature',
                    data: $("#__form").serialize() + "&submit=submit" + "&feature_id=" + ${feature.feature_id},
                    cache: false,
                    processData: false,
                    type: 'POST',
                    success: function (data) {
                        ...
                        if (data == "success") {
                            $(wrapper).append(
                                    '<div class="snackbar show" role="alert"><i class="fa fa-check-circle text-success"></i> Feature information updated successfully</div>'
                                    );
                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-8">
                            ...
                            <div class="card mb-4">
                                ...
                                <div class="card-header"><strong>Feature Details: ${feature.feature_name}</strong></div>
                                <div class="card-body">
                                    <form id="__form">
                                        ...
                                        <div class="row gx-3 mb-3">
                                            ...
                                            <div class="col-md-12">
                                                <label class="small mb-1" for="feature_name">Feature Name *</label>
                                                <input class="form-control" id="feature_name" type="text" name="feature_name" value ="${feature.feature_name}" placeholder="Enter your feature name" required>
                                        ...
                                        <div class="row gx-3 mb-3">
                                            <div class="col-md-6">
                                                <label class="small mb-1" for="team_id">Team ID *</label>
                                                <input class="form-control" id="team_id" type="text" name="team_id" value="${feature.team_id}" placeholder="Enter your team id" readonly>
                                                <div class="invalid-feedback">
                                                    Please give a Team's ID
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                        ...
                                        <div class="row gx-3 mb-3">
                                            <label class="small mb-1" for="description">Description (Optional)</label>
                                            <textarea name="description" rows="4" cols="20">${feature.getDescription()}
                                            </textarea>
                                        </div>
                        ...
                        <div class="col-xl-4">
                            <table border="0" class="table table-dark table-striped">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td>Team</td>
                                        <td>${feature.team_id}</td>
                                    </tr>
                                    <tr>
                                        <td>Class</td>
                                        <td>${feature.class_code}</td>
                                    </tr>
                                    <tr>
                                        <td>Trainer</td>
                                        <td>${feature.trainer_name}</td>
                                    </tr>
                                    <tr>
                                        <td>Subject</td>
                                        <td>${feature.subject_code}</td>
                                    </tr>
                                    <tr>
                                        <td>Status</td>
                                        <td>
                                            <c:if test="${feature.status==1}">
