                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-12">
                            ...
                            <div class="card mb-4">
                                ...
                                <div class="card-header"><strong>Add new subject</strong></div>
                                <div class="card-body">
                                    <form id="__form">
                                        ...
                                        <div class="row gx-3 mb-3">
                                            <div class="col-md-12">
                                                ...
                                                <input class="form-control" id="subject_code" type="text" name="subject_code"  placeholder="Enter your subject code" required>
                                        ...
                                        <div class="row gx-3 mb-3">
                                            <div class="col-md-12">
                                                ...
                                                <input class="form-control" id="subject_name" type="text" name="subject_name" placeholder="Enter your subject name" required>
                                                <div class="invalid-feedback">
