    ...
    <body>
                ...
                <div class="container-fluid">
                    ...
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb my-0 ms-2">
                            ...
                            <li class="breadcrumb-item active"><span>Subject List</span></li>
                        </ol>
                    </nav>
                </div>
            </header>
            ...
            <div class="body flex-grow-1 px-3">
                <div class="container-lg">
                    <div class="row">
                        <div class="card mb-4">
                            <div class="row">
                                <div class="card-header"><strong>Subject List</strong><span class="small ms-1"></span></div>
                                ...
                                <form method="GET" action="subject">
                                    ...
                                    <div class="table-responsive" id="notifi">
                                        <div class="input-group">
                                            <button class="btn btn-outline-secondary dropdown-toggle" type="button" data-coreui-toggle="dropdown" aria-expanded="false">Author</button>
                                            <ul class="dropdown-menu">
                                                <li><a class="dropdown-item" onclick="urlSearch('author_id', -1)">All</a></li>
                                                    <c:forEach var="i" items="${listAuthor}">
                                                    <li><a class="dropdown-item" onclick="urlSearch('author_id', ${i.getId()})">${i.getName()}</a></li>
                                                    </c:forEach>

                                            </ul>
                                            <button class="btn btn-outline-secondary dropdown-toggle" type="button" data-coreui-toggle="dropdown" aria-expanded="false">Trainer</button>
                                            <ul class="dropdown-menu">
                                                <li><a class="dropdown-item" onclick="urlSearch('trainer_id', -1)">All</a></li>
                                                    <c:forEach var="i" items="${listTrainer}">
                                                    <li><a class="dropdown-item" onclick="urlSearch('trainer_id', ${i.getId()})">${i.getName()}</a></li>
                                                    </c:forEach>
                                            ...
                                            <input class="form-control" type="text" id="inputSearch" value="${search_value}" placeholder="Search by subject code ..." aria-label="Text input with segmented dropdown button">
                                        ...
                                        <div  style="" >
                                            <div class="input-group" >
                                                <a class="btn btn-outline-secondary" href="subject?go=add" tabindex="-1" type="button" role="button" aria-disabled="true">
                                                    <svg class="icon">
                                        ...
                                        <table class="table table-dark table-striped" >
                                            <thead class="table-light fw-semibold" >
                                                <tr>
                                                    ...
                                                    <th>
                                                        Code 
                                                        <svg class="icon" id="subject_code" onclick="filter(this, '${filter_types[0]}')">
                                                        <use xlink:href="vendors/@coreui/icons/svg/free.svg#cil-swap-vertical"></use>
                                                        </svg>
                                                    </th>
                                                    <th>
                                                        Name
                                                        <svg class="icon" id="subject_name" onclick="filter(this, '${filter_types[1]}')">
                                                        <use xlink:href="vendors/@coreui/icons/svg/free.svg#cil-swap-vertical"></use>
                                                        </svg>
                                                    </th>
                                                    <th>
                                                        Author
                                                        <svg class="icon" id="full_name" onclick="filter(this, '${filter_types[2]}')">
                                                        <use xlink:href="vendors/@coreui/icons/svg/free.svg#cil-swap-vertical"></use>
                                                        </svg>
                                                    </th>
                                                    <th>
                                            ...
                                            <tbody>
                                                <c:forEach items="${subjects}" var="i">
                                                    <tr>
                                                <input type="hidden" name="subject_id" value="${i.getSubject_id()}">
                                                <td><b>${i.getSubject_code()}</b></td>
                                                <td>${i.getSubject_name()}</td>
                                                <td>${i.getFull_name()}</td>
                                                <td>${i.getEmail()}</td>
                                                <td class="text-center">
                                                    <div class="form-check form-switch">
                                                        <input  class="form-check-input" name="status" id="sw__${i.getSubject_id()}" fe="${i.getSubject_id()}" type="checkbox" ${i.getStatus() == 1 ? "checked" : ""}>
                                                    </div>
                                                </td>

                                                <td>
                                                    <a href="subject?go=edit&subject_id=${i.getSubject_id()}" class="btn btn-primary rounded-pill btn-sm" type="button">Edit</a>
                                                </td>
                                                </tr>
                                            </c:forEach>
                                            </tbody>
        ...
        <script>
                                                    function urlSearch(key, val) {
                                                        ...
                                                        var keys = "author|trainer|status".split("|");
                                                    ...
                                                    function filter(item, type) {
                                                        ...
                                                        var list_key = "subject_code|subject_name|full_name".split("|");
                                                    ...
                                                    function search() {
                                                        ...
                                                        url.searchParams.set("go", "viewAll");
                                                        url.searchParams.set("subject_search", valSearch);
                                                        document.location.search = url.search;
                                                    }
                                                    ...
                                                    function updateStatus(subject_id, status) {
                                                        ...
                                                        $.ajax({
                                                            url: 'subject',
                                                            data: "go=updateStatus&subject_id=" + subject_id + "&status=" + status,
                                                            cache: false,
                                                            processData: false,
                                                            type: 'POST',
                                                            success: function (data) {
                                                                if (data == "success") {
                                                                    if (status == 1)
                                                                        $('#sw__' + subject_id)[0].checked = true;
                                                                    else
                                                                        $('#sw__' + subject_id)[0].checked = false;
                                                                    $(wrapper).append(
                                                    ...
                                                    $('input[name="status"]').change(function () {
                                                        var subject_id = this.id.replace("sw__", "");
                                                        ...
                                                        if (this.checked) {
                                                            this.checked = false;
                                                            $("#rxzDglTitle").html("Activate this subject?");
                                                            $("#rxzDglBody").html("Do you want to active this subject?");
                                                            $("#rxzDglConfirm").click(function () {
                                                                updateStatus(subject_id, 1);
                                                            })


                                                        } else {
                                                            this.checked = true;
                                                            $("#rxzDglTitle").html("Inactivatethis subject?");
                                                            $("#rxzDglBody").html("Do you want to active this subject?");
                                                            $("#rxzDglConfirm").click(function () {
                                                                updateStatus(subject_id, 0);
                                                            })
                                                        }
                                                        $("#rxzDgl").modal("show")
                                                    });
