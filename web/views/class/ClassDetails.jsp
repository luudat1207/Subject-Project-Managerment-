                                        ...
                                        <table class="table">
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <input class="form-control" type="text" maxlength="20" value="${cat.getClass_code()}" name="class_code" id="inputclass_code">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <input class="form-control" type="number" value="${cat.getClass_year()}" id="input_year" name="year"  maxlength="20" required="">
                                                        <div class="invalid-feedback">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="row">
                                                            <div class="col-9">
                                                                <input class="form-control" type="text" name="term" value="${cat.getClass_term()}" id="input_term"  min="1" max="10" required="">
                                                                <div class="invalid-feedback">
                                                                    This information is not null.
                                                                </div>
                                                            </div>
