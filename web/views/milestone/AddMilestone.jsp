        ...
        <div class="wrapper d-flex flex-column min-vh-100 bg-light">
                                    ...
                                    <div class="card-body">
                                        <div class="row gx-3 mb-3">
                                            <div class="col-md-12">
                                                ...
                                                <select class="form-select form-select-sm" id="inputClassID" name="class_id" onchange="getIteration()" aria-label=".form-select-sm example">
            ...
            <script>
                function getIteration() {
                    ...
                    var id = document.getElementById('inputClassID').value;
                    $.ajax({
                        url: 'milestone',
